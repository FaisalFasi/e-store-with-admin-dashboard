          ...
          <nav className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              ...
              <>
                <Link
                  to="/signup"
                  className="bg-emerald-600 hover:bg-emerald-700 text-white py-1 md:py-2 px-2 md:px-4 text-sm md:text-base
                      rounded-md flex items-center transition duration-300 ease-in-out"
                >
                ...
                <Link
                  to="/login"
                  className="bg-gray-700 hover:bg-gray-600 text-white py-1 md:py-2 px-2 md:px-4 text-sm md:text-base
                      rounded-md flex items-center transition duration-300 ease-in-out"
                >
