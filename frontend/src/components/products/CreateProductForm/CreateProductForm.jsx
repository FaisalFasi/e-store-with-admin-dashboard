...
//     grandChildCategories: [], // Grandchild categories
//   });
//   useEffect(() => {
//     if (categories.length > 0) {
//       // Set the default parent category
//       const defaultCategory = categories[0]; // First parent category
//       const defaultSubCategory = defaultCategory.subCategories?.[0]; // First child category
//       const defaultGrandChildCategory =
//         defaultSubCategory?.subCategories?.[0]?._id || ""; // First grandchild category

//       setNewProduct((prev) => ({
//         ...prev,
//         category: defaultCategory._id, // Parent category ID
//         subCategory: defaultSubCategory?._id || "", // Child category ID
//         grandChildCategory: defaultGrandChildCategory, // Grandchild category ID
//       }));
...
//       selectedChildCategory: "", // Reset child category
//       grandChildCategories: [], // Reset grandchild categories
//     });
...
//       subCategory: "", // Reset child category
//       grandChildCategory: "", // Reset grandchild category
//     }));
//   };
...
//       grandChildCategory: selectedChildCategory?.subCategories?.[0]?._id || "", // Set the first grandchild category as default
//     }));
//   };
